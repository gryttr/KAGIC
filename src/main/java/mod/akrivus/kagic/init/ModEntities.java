...
public class ModEntities {
	...
	public static void registerGemYields() {
		...
		EntityRuby.RUBY_YIELDS.put(Blocks.STONE.getDefaultState(), 0.99);
		...
		EntitySapphire.SAPPHIRE_YIELDS.put(Blocks.STONE.getDefaultState(), 0.33);
		...
		EntityJasper.JASPER_YIELDS.put(Blocks.STONE.getDefaultState(), 0.11);
		...
		EntityAmethyst.AMETHYST_YIELDS.put(Blocks.STONE.getDefaultState(), 0.44);
		...
		EntityRoseQuartz.ROSE_QUARTZ_YIELDS.put(Blocks.STONE.getDefaultState(), 0.11);
		...
		EntityCarnelian.CARNELIAN_YIELDS.put(Blocks.STONE.getDefaultState(), 0.33);
