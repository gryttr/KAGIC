...
public class TileEntityGalaxyPadCore extends TileEntityWarpPadCore {
	...
	protected void setDirty() {
		...
		if (!this.world.isRemote) {
			GalaxyPadLocation gLoc = new GalaxyPadLocation(this.world.provider.getDimension(), this.pos);
			WorldDataGalaxyPad.get(this.world).addGalaxyPadEntry(name, this.isPadValid, this.isClear, gLoc);
		}
	}
