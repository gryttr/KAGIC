...
public class EntityAIRetroVision extends EntityAIBase {
	...
	public boolean shouldExecute() {
		return this.gem.getOwner() != null && this.gem.getOwner().getDistanceSq(this.gem) < 16 && this.gem.world.getTotalWorldTime() - this.lastPrediction > 200 + this.gem.world.rand.nextInt(200);
	}
